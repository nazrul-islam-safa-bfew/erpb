...
?>
<form id="form1" name="form1" method="post" action="Edit_repair_services_AddPartsUsedMedium.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="617" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF6633" style="border-color:#FF0000">
    <tr bgcolor="#33CC33">
    ...
    <tr>
      <td width="155" bgcolor="#FF99FF">Part Number :      </td>
    ...
    <tr bgcolor="#33CC33">
      ...
      <td width="68">&nbsp;</td>
      <td width="202"><input name="Close" type="button" id="Close" value="   Close  " onclick="goClose()"/></td>
    </tr>
  </table>
  <p>
