...
//---Assigning Posted value from EditNewEmployeeContact.php to the variable---//
...
{
echo"Could Not Connect to The Database...<p><a href=EditNewEmployeeContact.php>Back</a>";
}
