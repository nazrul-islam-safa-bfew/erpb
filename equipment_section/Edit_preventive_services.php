<?php 
include("common.php");
//-------------Retreiving session initiated at Edit_work_order.php page ..........//
...
<title>Edit Work Worder ( #<?php echo"$work_order_id"; ?>) - PM Entry Form</title>
...
<form action="Edit_preventive_services_EntryMedium.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <p>
    ...
    <tr bgcolor="#CCCCCC">
      ...
      <td>Extended</td>
							...
							while($rs=mysql_fetch_row($qryexecute))
							{
								...
								$qry1="SELECT emp_Name FROM add_new_employee WHERE emp_id='$emp_id'";
								$qryexecute1=mysqli_query($db, $qry1);
