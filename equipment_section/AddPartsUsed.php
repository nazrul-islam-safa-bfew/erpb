...
<title>Work Order (#<?php echo"$work_order_id"; ?>) PM Task - Parts Entry Form</title>
...
?>
<form id="form1" name="form1" method="post" action="AddPartsUsedMedium.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="586" border="0" align="center" cellpadding="0" cellspacing="0" style="border-color:#FF0000">
    <tr>
    ...
    <tr bgcolor="#FF99FF">
      <td width="245" bgcolor="#FF99FF">Part Number : </td>
      <td colspan="3"><label>
    ...
    <tr bgcolor="#FF99FF">
      <td>Description : </td>
      <td colspan="3"><input name="txtDesc" type="text" id="txtDesc" size="55" value="<?php echo"$part_desc"; ?>"/></td>
    </tr>
    <tr bgcolor="#FF99FF">
      <td>Warrenty (Year): </td>
      <td colspan="3"><input name="txtWarrenty" type="text" id="txtWarrenty" size="55" value="<?php echo"$part_warranty"; ?>" /></td>
    </tr>
    <tr bgcolor="#FF99FF">
      <td>Quantity Used : </td>
      <td colspan="3"><label>
    ...
    <tr bgcolor="#FF99FF">
      <td>Unit Cost : </td>
      <td colspan="3"><input name="txtUnitCost" type="text" id="txtUnitCost" value="<?php echo"$part_unit_cost"; ?>" /></td>
    </tr>
    <tr bgcolor="#FF99FF">
      <td>Extended Cost : </td>
      <td colspan="3"><input name="txtExtendedCost" type="text" id="txtExtendedCost" READONLY/></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr bgcolor="#33CC33">
      ...
      <td width="156"><input name="save" type="button" id="save" value="     Save    " onclick="doFinish(form1)"/></td>
      <td width="4">&nbsp;</td>
      <td width="181"><input name="Close" type="button" id="Close" value="   Close  " onclick="goClose()"/></td>
    </tr>
  </table>
  <p>
