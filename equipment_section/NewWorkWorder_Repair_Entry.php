...
<title>Work Worder (#<?php echo"$work_order_id"; ?>) - Repair Entry Form</title>
...
<form action="NewWorkWorder_Repair_EntryMedium.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <p>
...
$repair_type=$_SESSION['repair'];
							...
							while($rs1=mysql_fetch_row($qryexecute1))
							{
								...
								$qry2="SELECT name FROM employee WHERE empId='$emp_id'";
