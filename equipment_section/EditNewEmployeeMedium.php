...
//---Query to insert record in the add_new_employee TABLE----//
$qry="UPDATE add_new_employee SET emp_Name='$emp_name',emp_status='$emp_status',emp_location='$emp_location',emp_category='$emp_category',emp_type='$emp_type',emp_labor_rate='$emp_labor_rate',emp_ssn='$emp_ssn',emp_hire_date='$emp_hire_date',emp_physical_date='$emp_last_date',emp_dob='$emp_dob',emp_leave_date='$emp_leave_date',emp_physical_due_date='$emp_physical_due_date',emp_driver_license_number='$emp_driving_license_number',emp_driver_license_class='$emp_license_class',emp_driver_license_state='$emp_license_city',emp_driver_license_expire_date='$emp_license_espire_date',emp_driver_license_note='$emp_license_note',created_date='$create_date' WHERE emp_id='$emp_id'";

$qryexecute=mysqli_query($db, $qry);

if($qryexecute)
{
header("Location: EditNewEmployeeContact.php");
}
else
{
