...
//this will delete the record from the invoice_sub if the user close/Exit the page(GenerateInvoice.php) without save it...
else if($hid==2)
{
//retreive session value which conatins the invoice number...
session_start();
...
$qry2="DELETE FROM invoice_sub WHERE invoice_num='$invoice_num'";
