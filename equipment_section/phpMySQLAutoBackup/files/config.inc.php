 ...
 */
 // Modified file by http://www.dwalker.co.uk
//for changes see:
// --mod-- 1-July2004
...
// --mod-- 1-July2004
$cfg['Servers'][$i]['user']          = $mysql_username;      // MySQL user
$cfg['Servers'][$i]['password']      = $mysql_password;          // MySQL password (only needed
$cfg['Servers'][$i]['only_db']       = $db;          // If set to a db-name, only
