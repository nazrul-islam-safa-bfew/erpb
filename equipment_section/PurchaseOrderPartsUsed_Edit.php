...
$qry="UPDATE purchaseorder_parts_info SET part_name='$part_name',part_warranty='$part_Warrenty',part_order_quantity='$part_Quantity',part_unit_cost='$part_UnitCost',part_extended_cost='$part_ExtendedCost',notes='$part_Notes' WHERE po='$po_num' AND part_number='$part_num'";
$qryexecute=mysqli_query($db, $qry);
...
{
$part_num=$_POST['SelectPartNumber'];
$qry2="DELETE FROM purchaseorder_parts_info WHERE po='$po_num' AND part_number='$part_num'";
...
<form id="form1" name="form1" method="post" action="">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="490" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF6633" style="border-color:#FF0000">
    <tr>
    ...
    <tr bgcolor="#FF99FF">
      <td width="129" bgcolor="#FF99FF">Part Number : </td>
      <td colspan="3"><label>
	  
								<select name="SelectPartNumber" id="SelectPartNumber" onchange="goChange(SelectPartNumber.value)">
								 <option value="" selected="selected"></option>
								
								 <?php  //--select parts alredy added to purchase order($po_num)..
										$rs="SELECT part_number FROM purchaseorder_parts_info WHERE po='$po_num'";
    ...
    <tr bgcolor="#33CC33">
      ...
      <td width="90"><input name="save" type="button" id="save" value="     Update   " onclick="doFinish(form1)"/></td>
      <td width="147"><label>
        <center><input name="BDelete" type="button" id="BDelete" value="   Delete   " onclick="goDelete()"/></center>
      </label></td>
      <td width="124"><input name="Close" type="button" id="Close" value="   Close  " onclick="javascript:location.href='purchaseOrder_Parts_Managment_Edit.php'"/></td>
    </tr>
  </table>
  <p>
