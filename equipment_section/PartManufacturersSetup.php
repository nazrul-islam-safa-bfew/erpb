...
<title>Part Manufacturers Entry Form</title>
...
{
if(frmmake.txtmanu.value=="")
{
alert("Please Enter Manufacturer Name.");
frmmake.txtmanu.focus();
return false;
}
return true;
}
...
<body>
<form id="frmmake" name="frmmake" method="post" action="PartManufacturersSetupSuccessful.php">
<table width="363" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" bgcolor="#33CC33">Equipment Manufacturer Name - Entry Form</td>
  </tr>
  <tr bgcolor="#FF99FF">
    <td width="198">Enter Manufacturer Name</td>
    <td width="231"><input name="txtmanu" type="text" id="txtmanu" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
