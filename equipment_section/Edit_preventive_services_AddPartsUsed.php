...
?>
<form id="form1" name="form1" method="post" action="Edit_preventive_services_AddPartsUsedMedium.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="475" border="0" align="center" cellpadding="0" cellspacing="0" style="border-color:#FF0000">
    ...
    <tr bgcolor="#FF99FF">
      <td width="160" bgcolor="#FF99FF">Part Number : </td>
      <td colspan="3"><label>
    ...
    <tr bgcolor="#33CC33">
      ...
      <td width="86"><input name="save" type="button" id="save" value="     Save    " onclick="doFinish(form1)"/></td>
      <td width="46">&nbsp;</td>
      <td width="183"><input name="Close" type="button" id="Close" value="   Close  " onclick="goClose()"/></td>
    </tr>
  </table>
  <p>
