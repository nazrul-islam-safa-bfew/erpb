...
function goEdit(m)
{
location.href='Edit_GenerateInvoice_Payment_Edit.php?trans_id=' + m;
}
...
{
var l=1;
location.href='Edit_Generate_Invoice.php?count=' + l;
}
    ...
    <tr bgcolor="#33CC33">
      ...
      <td width="161">Transaction # </td>
										...
										/*(, amount_receive, date_receive, payment_method, check_num, credit_card_num, credit_card_name, credit_card_expire_mo,credit_card_expire_year, credit_card_transaction, other_mode_of_payment*/
											...
											$qry="SELECT * FROM invoice_sub WHERE invoice_num='$e_invoice_num'";
