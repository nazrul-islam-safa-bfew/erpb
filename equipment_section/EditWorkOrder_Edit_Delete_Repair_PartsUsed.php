...
include("common.php");
CreateConnection();
//------------------------restoring session values-----------------



//------------------------END--------------------------------------

//-----------------------Code Will be executed when the form is edited-----------------------------
...
<title>Work Order (#<?php echo"$work_order_id"; ?>)Repair - Parts Edit / Delete Form</title>
...
?>
<form id="form1" name="form1" method="post" action="EditWorkOrder_Edit_Delete_Repair_PartsUsedMedium.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="475" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF6633" style="border-color:#FF0000">
    ...
    <tr>
      <td width="113" bgcolor="#FF99FF">Part Number : </td>
      <td colspan="3" bgcolor="#FF99FF"><label>
								...
								<select name="SelectPartNumber" id="SelectPartNumber" onchange="goChange(SelectPartNumber.value)">
								 ...
								 <?php  
														...
														$rs="SELECT itemCode FROM itemlist";
    ...
    <tr bgcolor="#FF99FF">
      ...
      <td colspan="3" bgcolor="#FF99FF"><input name="txtExtendedCost" type="text" id="txtExtendedCost" value="<?php echo"$part_extended_cost"; ?>"/></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr bgcolor="#33CC33">
      ...
      <td width="102"><input type="button" name="Submit3" value="   Delete   " onclick="goDelete()"/></td>
