...
//echo("$pm_service_id");
//----------------------Clling AddPartsUsed.php page for part association-----------------
if($hid==1)
{
header("Location: AddRepairPartsUsed.php");
}
//---For Edit
else if($hid==2)
{
...
header("Location: Edit_Delete_Repair_PartsUsed.php?Part_ID=$part_id&part_name=$part_name&part_desc=$part_desc&part_warranty=$part_warrenty&part_quantity=$part_quantity&part_unit_cost=$part_unit_cost&part_extended_cost=$part_extended_cost");
...
//----------------------Saving the entry of NewWorkOrder_Repair_Entry.php Page.................
...
//-------------------------------Tracking ADD(Labor section) Buttons onClick Event(NewWorkWorder_Repair_Entry.php page)------
else if($hid==5)
{
header("Location: NewWorkWorder_Add_Repair_LaborUsed.php");
}
