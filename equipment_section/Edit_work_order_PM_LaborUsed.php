...
//-------------------------------------------------END-----------------------------------
$hid=$_POST['hidField'];
//--this portion will be executed wheen the form is submitted to itself(Save the Record).....
if($hid==1)
{
...
//check wheather the labor is already added to the work order...
$check="SELECT * FROM new_work_order_pm_labor_used WHERE work_order_id='$work_order_id' AND pm_service_id='$pm_service_id' AND emp_id='$tech_id'";
$execute_chk=mysqli_query($db, $check);
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="384" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#33CC33">
      ...
      <td bgcolor="#33CC33">
        <div align="center">
          <input name="close" type="button" id="close" value="      Close     " onclick="javascript:location.href='Edit_preventive_services.php'"/>
        </div></td>
    </tr>
  </table>
  <p>&nbsp;</p>
