...
//retreiving session value which hold the itm_track_id for the item that needs to de deleted
session_start();
...
<title>Equipment Information Delete Form</title>
<style type="text/css">
<!--
.style1 {
...
var n=m;
document.form1.hid_item_id.value=n;
...
//echo("$itm_id");
?>
<form id="form1" name="form1" method="post" action="DeleteNewEquipmentMedium.php">
    ...
    <table width="705" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
      ...
      <tr>
        <td width="132">Equipment ID :</td>
        <td colspan="2"><label><select name="item_id" id="item_id" onchange="goChange(item_id.value)">
...
include("modified_common.php");
      ...
      <tr>
        <td>Specification :</td>
        <td colspan="2"><input name="txtspecification" type="text" id="txtspecification" value="<?php echo $_GET['item_desc']; ?>"/></td>
        <td>Meter Type :</td>
        <td><select name="selectMeter" id="selectMeter">
...
include("modified_common.php");
      ...
      <tr>
        ...
        <td><a href="javascript:NewCal('basedate','yyyymmdd','true',12)">
          <input name="basedate" type="text" id="basedate" size="15" value="<?php echo $_GET['item_base_date']; ?>"/>
          <img src="cal.gif" alt="Calender" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr>
        <td>Serial# :</td>
        <td colspan="2"><input name="txtserial" type="text" id="txtserial" value="<?php echo $_GET['item_desc']; ?>"/></td>
        <td>Status : </td>
...
include("modified_common.php");
      ...
      <tr>
        ...
        <td width="117"><input type="button" name="Submit4" value="Browse" accesskey="B" /></td>
        <td>&nbsp;</td>
    ...
    <table width="705" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr bgcolor="#33CC33">
        ...
        <td width="298">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        <input name="cmbSave" type="button" id="cmbSave" accesskey="S" value="   Delete Information   " onclick="goDelete()" /></td>
        <td width="295"><center>
          <input name="cmbClose" type="button" id="cmbClose" accesskey="l" value="     Close Form    " onclick="javascript:location.href='index.php'" />
        </center></td>
        <td width="35">&nbsp;</td>
      </tr>
    </table>
