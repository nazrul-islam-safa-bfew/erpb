...
//$med=?;
//$trn=?;
$salary=($curbasic+$houserent+$med+$trn)-$profund;
...
print $sqlitem = "INSERT INTO `employee` ( `empId` , `name` , `designation` ,`addJob` , `empDate` ,`creDate` ,`proDate` ,`jobTer`,".
									" `pament` , `salaryType` , `salary` ,`allowance`,`edate`, `location`, `status`,`initbasic`,increment,curbasic,houserent,medical,transport,profund)".
                            "VALUES ( '' , '$name' , '$designation' ,'$addJob', '$empDate' ,'$creDate' ,'$proDate','',".
									" '$pament' , '$salaryType' , '$salary' , '$allowance' ,'$todat' ,'000','0','$txtbasic','$txtincrement',$curbasic,$houserent,'$txtmedical','$txttransport',$profund)";
}
