...
if($empStatus=='-1') echo '<font class=outi>Terminate on '.myDate($re[jobTer]).'</font>';
 ?>
   ...
   <td valign="top" align="right" ><? $houseRent=houseRent($re[designation]); echo number_format($houseRent,2);?></td> 
   <td valign="top" align="right" ><? $medical=medical($re[designation]); echo number_format($medical,2);?></td> 
   <td valign="top" align="right" ><? $convence=convence($re[designation]); echo number_format($convence,2);?></td>          
   <? }//else?>
