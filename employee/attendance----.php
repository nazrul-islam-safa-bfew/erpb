...
?>
 ...
 <input type="button" name="go" value="Go" onClick="document.location.href='./index.php?keyword=attendance&d='+document.attendance.d.value+'&project='+document.attendance.project.value">
...
$acv2='P';
 ...
 //<!--Added by suvro 19-05-14-->
if($project)
$emp_project=$project;
else
$emp_project=$loginProject;
//<!--End of added! 19-05-14-->
