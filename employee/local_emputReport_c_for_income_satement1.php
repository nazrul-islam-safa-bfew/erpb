...
$edat='01/01/2014';
$project='195';
$first_date_of_edate='01/01/2014';
*/

$first_date_of_edate=$fromDate;
...
$edat2=formatDate($first_date_of_edate,$format);
...
$sqlp = "SELECT DISTINCT employee.designation,itemlist.* from `itemlist`,employee Where itemCode >= '86-00-000' AND itemCode <= '97-00-000'".
...
SELECT DISTINCT attendance.empId,employee.designation,employee.salary,employee.allowance FROM attendance,employee where attendance.location='195' AND attendance.edate>='2014-02-1' and attendance.edate<='2014-02-16' AND action in('P','HP') AND attendance.empId=employee.empId AND employee.designation>='86-00-000' AND employee.designation<='89-99-000' ORDER by designation,empId ASC
...
" where attendance.location='$project' AND attendance.edate='$edat2'".
...
$sqlquery1="SELECT * FROM attendance".
" where attendance.location='$project' ".
"AND attendance.edate BETWEEN '$edat2'".
" AND action in('P','HP') AND attendance.empId= $re[empId]";
//echo $sqlquery1;
...
$siowDaysRem=siowDaysRem($dmar[dmasiow],$edat2);
$siowDaysGan=siowDaysGan($dmar[dmasiow],$edat2);
...
return $normalDayAmountgTotalup_finual+$total_idle_amount;
}//end get_total_idle_amount
//designation
...
$my_arr_for_speed[]=$total_idle_amount;
$my_arr_for_speed[]=$normalDayAmountgTotalup_finual;
return $my_arr_for_speed;
...
return $normalDayAmountgTotalup_finual;
}//end get_total_idle_amount
//designation
//echo $normalDayAmountgTotalup_finual." // idle=<br>";
//echo $total_idle_amount;
