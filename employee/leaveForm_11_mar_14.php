...
$db = mysqli_connect($SESS_DBHOST, $SESS_DBUSER,$SESS_DBPASS,$SESS_DBNAME);
 ...
 $sql=@mysqli_query($db, "SELECT * FROM employee WHERE (salaryType='Salary' OR salaryType='Consolidated' OR salaryType='Wages Monthly' )
  AND location='000' AND status='0' AND designation!='70-01-000' ORDER by designation") or die('Please try later!!');
