...
{
	echo '<option value="90-00-000">90-00-000 Direct Labour Skilled Daily Basis</option>';
	echo '<option value="91-00-000">91-00-000 Direct Labour Unskilled</option>';	
}
 ?>
</select>
...
<tr >
  ...
  <td ><input type="text" name="salary" value="<? echo $eqresult[salary];?>"  alt="req" title="Enter Wages" > Tk./ Month</td>
</tr>
