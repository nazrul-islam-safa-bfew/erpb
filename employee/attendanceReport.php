...
<tr >
 <td height="30" class="humanHd_small" width="45%">employee</td> 
...
WHERE salaryType in ('salary','Wages Monthly','salaried','Wages Monthly Master Roll') 
AND status=0 AND designation!='70-01-000'";
if(!$project)$project="000";
if($loginProject=='000') 
