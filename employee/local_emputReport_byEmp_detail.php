...
<tr bgcolor="#CC9999">
 <td colspan="5" align="right" valign="top"><font class='englishhead'>employee utilization report of <? echo myDate($edate);?></font></td>
</tr>
<tr>
 <th>From</th>
 <th>To</th> 
...
<? $t=empExTime($empId,$empType,$edate);
      $eh= $t[eh];
      $em= $t[em];
      $xh= $t[xh];
      $xm= $t[xm];	  	  	  
...
//$sqlut = "SELECT * FROM emput WHERE empId='$empId' AND edate='$edate' AND pcode='$loginProject' ORDER by stime ASC";
$sqlut = "SELECT * FROM emput WHERE empId='$empId' AND edate='$edate' ORDER by stime ASC";
//echo $sqlut;
...
<p align="center">
<? 
$dailyworkBreakt=dailyworkBreak($empId,$edate,$empType,$pcode);

$toDaypresent=toDaypresent($empId,$edate,$empType,$pcode)-$dailyworkBreakt;

$workt= dailywork($empId,$edate,'H',$pcode);
