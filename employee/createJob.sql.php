...
$sqlp=" UPDATE `jobdetails` set `jobTitle`='".textok($jobTitle)."', `level`='".textok($level)."', `summary`='".textok($summary)."', `education`='".textok($education)."',  `experience`='".textok($experience)."', `training`='".textok($training)."', `skill`='".textok($skill)."', `ability`='".textok($ability)."', `incumbent`='".textok($incumbent)."',  `administrative`='".textok($administrative)."', `financial`='".textok($financial)."', `performance`='".textok($performance)."', `conditions`='".textok($conditions)."',  `nature`='".textok($nature)."', `dduties`='".textok($dduties)."', `pduties`='".textok($pduties)."', `iduties`='".textok($iduties)."', `startingBasic`='$startingBasic', `houseRent`='$houseRent', `medical`='$medical', `convence`='$convence', `proFund`='$proFund', `increment`='$increment',  `maxIncrement`='$maxIncrement',`personality_trait`='$_POST[personality_trait]' WHERE `itemCode`='$itemCode' "; 
