...
?>	
    <td><input type="text" size="3" maxlength="2" name="itemCode1">-<input type="text" size="3" maxlength="2" name="itemCode2">-<input type="text" size="3" maxlength="2" name="itemCode3"> 	</td>
	<? }//else ?>
	</tr>
	<tr>
	<td width="200">Job Title </td>
	<td><input type="text" size="50" name="jobTitle" value="<? echo $app['jobTitle'];?>"></td>
	</tr>
	<tr>
	...
	<td colspan="2">Job Requirements
	 <table width="100%">
	  <tr>
	    <td width="200" valign="top"><li>Personality Traits</li></td>	<td><textarea  cols="110" rows="3" name="personality_trait"><? echo $app['personality_trait'];?></textarea></td>
	   </tr>
	   <tr>
