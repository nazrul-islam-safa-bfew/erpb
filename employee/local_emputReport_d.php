...
$sqlp = "SELECT itemlist.itemCode,itemlist.itemDes,employee.empId,employee.name from
 employee,`itemlist` Where status='0' AND itemCode >= '82-00-000' AND itemCode < '98-01-000' 
...
?>
 ...
 echo $hour_row[stime]." - ".$hour_row[etime]. " : ";
  ...
  <td align="center"> <?  $overtime=sec2hms($overtimet/3600,$padHours=false);  echo $overtime.' Hrs.';  echo $totalOverTime=$totalOverTime+$overtimet;
   ?></td>
