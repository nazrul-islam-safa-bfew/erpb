...
?>
<form name="store" action="index.php?keyword=employee+Details&page=1" method="post">
<table align="center" width="400" class="human" >
<tr  >
 <td colspan="2" align="right" valign="top" class="humanHd">human resource Search form</td>
</tr>
...
$sql.=" AND employee.empId not in (select empId from appaction where action='1' and actionStatus='0' and date1!='')";
...
if($getItemDesCode==$sqlresult[ccr]){ ?>
...
// 	echo "($sqlresult[empId], $app[appId]";
...
<tr bgcolor="#e0e0ff">
  ...
  <i>Appraised by <b><font color='#f00'><? echo $temp[supervisor];?></font></b> <? if($app[todat]!='0000-00-00' && $app[todat])echo "on <b><font color='#f00'>".date("F d, Y",strtotime($app[todat]))."</font></b>";?></i>
  </td>
</tr>
<? }//app?>
...
$testp= $test;
 ...
 <?php
        ...
        $range= 5;
		$rootLink="./index.php?keyword=employee+details";
