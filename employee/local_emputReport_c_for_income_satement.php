...
curl_setopt($ch,CURLOPT_TIMEOUT,6000000);
...
$edat='30/12/2013';
$project='193';
$first_date_of_edate='09/12/2013';
*/
...
" where attendance.location='$project' AND attendance.edate>='$edat2' and attendance.edate<='$edat1'".
...
" AND attendance.edate>='$edat2' AND attendance.edate<='$edat1'".
...
$sqlquery1="SELECT * FROM attendance".
" where attendance.location='$project' ".
"AND attendance.edate BETWEEN '$edat2' AND '$edat1'".
" AND action in('P','HP') AND attendance.empId= $re[empId]";
//echo $sqlquery1;
