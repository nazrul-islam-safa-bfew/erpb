...
$sqlp11.=" ORDER by point DESC LIMIT $curr,$total_per_page";
//$sqlp11.=" ";
//echo $sqlp11;
	$sqlrunp11= mysql_query($sqlp11);
...
while($vendor= mysql_fetch_array($sqlrunp11)){
?>

<table align="center" width="95%"   border="2" bordercolor="#E8E8E8" cellspacing="0" cellpadding="3" style="border-collapse:collapse">
 <TR bgcolor="#EEEEEE">
		  <TD width="50%"  >Vendore Name:
		  <a class="hd" href="./index.php?keyword=vendor&vid=<? echo $vendor[vid];?>"> <? echo $vendor[vname];?></a>
		  </TD>
		  <TD  align="right">
...
<TR><TD colspan="2">
   <table align="center" width="100%" border="1" bordercolor="#CCCCFF" cellpadding="5" cellspacing="0" style="border-collapse:collapse">
        ...
        <? include("config.inc.php");
$dbq = mysql_connect($SESS_DBHOST, $SESS_DBUSER,$SESS_DBPASS);
	mysql_select_db($SESS_DBNAME,$db);
...
//echo $sqlq;
$sqlrunq= mysql_query($sqlq);
while($qresult= mysql_fetch_array($sqlrunq)){
?>
        <tr > 
...
<b>GO TO :
<? /*
for($i=1;$i<=ceil($total_result/$total_per_page);$i++)
	{
	if($i==$page)
		{
		echo " | <i><b>$i</b></i> | ";
		...
		{
		echo " | <a href=./index.php?keyword=vendor+Report&page=$i><font color=#0000FF>$i</font></a> | ";
		}
	}
	*/
?>
