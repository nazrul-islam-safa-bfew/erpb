...
<? 
$sqlv = "SELECT DISTINCT store.itemCode,AVG(store.rate) as rate,itemlist.* from `store`, itemlist WHERE store.itemCode= itemlist.itemCode ";
$sqlv.= " GROUP by store.itemCode ORDER BY store.itemCode ASC";
//echo $sqlv;
$sqlrunq= mysql_query($sqlv);
...
<TR>
          ...
          <td align="left" width="20%" ><? echo "from Central Store";?></td>
          <td  align="right" width="10%" > <? echo number_format($store[rate],2);?></td>
          <td  align="center" width="10%" > <? echo $store[itemUnit];?></td>
