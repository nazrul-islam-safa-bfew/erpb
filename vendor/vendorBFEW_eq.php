...
$sqlv = "SELECT equipment.assetId, equipment.itemCode,MAX(((((price-salvageValue)/life)/days)*6)/30) as rate,itemlist.* from `equipment`, itemlist WHERE equipment.itemCode= itemlist.itemCode ";
