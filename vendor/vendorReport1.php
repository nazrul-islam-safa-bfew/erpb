 ...
 <tr>
  <td  colspan="8">
    <table align="center" width="100%"   border="1" bordercolor="#E8E8E8" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
	 ...
	 <TR >
	  <TD >Address :<font class="out"><? echo $vendor[address];?></font></TD>
	  <td align="right"><a href="<? echo $vendor[att];?>"><img src="./images/pdf_icon.jpg" width="30" height="30" border="0" align="absbottom" ></a></td>
	 </TR>
...
<TR>
          ...
          <td  align="right" width="10%" > <? echo number_format($vendor[rate],2).' /'.$vendor[itemUnit];?></td>
          <td align="center" width="10%" > <? echo $vendor[qRef];?></td>
          <td align="center" width="10%" > <? echo date("d-m-Y",strtotime($vendor[valid]));?> 
            <a href="#" onClick='if(confirm("Are you sure ?")) window.location="./vendor/quoSql.php?qid=<? echo $qresult[qid];?>&delete=1"'><img src="./images/b_drop.png" border="0" align="absbottom"></a> 
          </td>
</TR>
