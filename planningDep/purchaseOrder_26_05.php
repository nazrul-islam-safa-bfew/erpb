...
if($r>0){
	...
	for($i=1;$i<=$n;$i++)
	{
	 ...
	 ${porderQty.$i}=round(${porderQty.$i},3);
	  ...
	  " VALUES ('','$posl','$acctPayable','$project','${itemCode.$i}','${porderQty.$i}','${rate.$i}', '$vid','-1','${qref.$i}','" . mysql_real_escape_string(${deliveryDetails.$i}). "','$d','$activeDate1','$todat','$potype')";
	 //echo "$sqlp<br>";
  ...
  <table align="center" width="95%" border="1" bordercolor="#CCCCFF" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
	...
	<td>
        ...
        <? $posl=posl($project,$vid,1); echo $posl; //$posl='p'.$vid.'_000001';?>
         <input type="hidden" name="posl" value="<? echo $posl;?>"><br>	
  ...
  <table align="center" width="98%" border="1" class="ablue">
    <tr class="ablueAlertHd_small2"> 
      <td >Receiving will start at 
        <input type="text" name="dstart" size="7"> <a id="anchor0" href="#"
   ...
   name="anchor0" ><img src="./images/b_calendar.png" alt="calender" border="0"></a></td>
      ...
      <td  > <input type="text" name="sdate1"  size="7"><a id="anchor12" href="#"
   ...
   name="anchor12" ><img src="./images/b_calendar.png" alt="calender" border="0"></a></td>
      <td  > <input type="text" name="sdate2"  size="7"><a id="anchor2" href="#"
   ...
   name="anchor2" ><img src="./images/b_calendar.png" alt="calender" border="0"></a></td>
      <td  > <input type="text" name="sdate3"  size="7"><a id="anchor3" href="#"
   ...
   name="anchor3" ><img src="./images/b_calendar.png" alt="calender" border="0"></a></td>
      <td > <input type="text" name="sdate4"  size="7"><a id="anchor4" href="#"
   ...
   name="anchor4" ><img src="./images/b_calendar.png" alt="calender" border="0"></a></td>
      <td  > <input type="text" name="sdate5"  size="7"><a id="anchor5" href="#"
   ...
   name="anchor5" ><img src="./images/b_calendar.png" alt="calender" border="0"></a></td>
      <td > <input type="text" name="sdate6"  size="7"><a id="anchor<? echo $j;?>1" href="#"
   ...
   name="anchor6" ><img src="./images/b_calendar.png" alt="calender" border="0"></a></td>
      <td > <input type="text" name="sdate7"  size="7"><a id="anchor7" href="#"
...
?>
    <tr <? if($j%2==1) echo "bgcolor=#EEEEEE";?> > 
      ...
      <td><input type="text" name="qty2_<? echo $j;?>" onBlur="purchaseOrder.qty3_<? echo $j;?>.value = <? echo ${porderQty.$j}; ?> - purchaseOrder.qty1_<? echo $j;?>.value- purchaseOrder.qty2_<? echo $j;?>.value ;" style="text-align:right" size="7"> 
        <? echo $temp[unit];?></td>
      <td><input type="text" name="qty3_<? echo $j;?>" onBlur="purchaseOrder.qty4_<? echo $j;?>.value = <? echo ${porderQty.$j}; ?> - purchaseOrder.qty1_<? echo $j;?>.value- purchaseOrder.qty2_<? echo $j;?>.value- purchaseOrder.qty3_<? echo $j;?>.value ;" style="text-align:right" size="7"> 
        <? echo $temp[unit];?></td>
      <td><input type="text" name="qty4_<? echo $j;?>" onBlur="purchaseOrder.qty5_<? echo $j;?>.value = <? echo ${porderQty.$j}; ?> - purchaseOrder.qty1_<? echo $j;?>.value- purchaseOrder.qty2_<? echo $j;?>.value- purchaseOrder.qty3_<? echo $j;?>.value- purchaseOrder.qty4_<? echo $j;?>.value ;" style="text-align:right" size="7"> 
        <? echo $temp[unit];?></td>
      <td><input type="text" name="qty5_<? echo $j;?>" onBlur="purchaseOrder.qty6_<? echo $j;?>.value = <? echo ${porderQty.$j}; ?> - purchaseOrder.qty1_<? echo $j;?>.value- purchaseOrder.qty2_<? echo $j;?>.value- purchaseOrder.qty3_<? echo $j;?>.value- purchaseOrder.qty4_<? echo $j;?>.value- purchaseOrder.qty5_<? echo $j;?>.value ;" style="text-align:right" size="7"> 
        <? echo $temp[unit];?></td>
      <td><input type="text" name="qty6_<? echo $j;?>" onBlur="purchaseOrder.qty7_<? echo $j;?>.value = <? echo ${porderQty.$j}; ?> - purchaseOrder.qty1_<? echo $j;?>.value- purchaseOrder.qty2_<? echo $j;?>.value- purchaseOrder.qty3_<? echo $j;?>.value- purchaseOrder.qty4_<? echo $j;?>.value- purchaseOrder.qty5_<? echo $j;?>.value- purchaseOrder.qty6_<? echo $j;?>.value ;" style="text-align:right" size="7"> 
        <? echo $temp[unit];?></td>
