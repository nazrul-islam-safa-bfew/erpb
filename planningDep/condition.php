...
<td style="display:none"><input type="checkbox" name="ch1" value="ch1" <? if($ch1) echo 'checked';?> onClick="chk3(ch1,ch2,ch3,1);" ></td>
<td>All Materials must be supplied as per Approved Quality maintaining Delivery Schedule. </td>
</tr>
<tr>
<td><input type="checkbox" name="ch2" value="ch2" <? if($ch2) echo 'checked';?> onClick="chk3(ch1,ch2,ch3,2);"></td>
<td>All Materials must be supplied as per Standard Quality maintaining Delivery Schedule.</td>
</tr>

<tr>
 <td><input type="checkbox" name="ch3" value="ch3"  <? if($ch3) echo 'checked';?> onClick="chk3(ch1,ch2,ch3,3);"></td>
 <td>All Materials must be supplied as per Approved Sample maintaining Delivery Schedule.</td>
</tr>
<tr>
...
<tr>
 <td><input type="checkbox" name="ch5" value="ch5"  <? if($ch5) echo 'checked';?> disabled></td>
<td>In case supplier fails to maintain schedule but BFEW agrees to accept that supply, <input type="text" name="tch51" value="<? echo $tch51;?>" size="5">% amount will be deducted from the Bill amount on account of supplier's failure to supply the quantity as per Schedule.<i>(Under Construction)</i></td>
</tr>
<tr>
...
<td>No Delivery will be accepted in Project Holiday.</td>
</tr>
<tr>
...
if (eval("document.purchaseOrder."+chname1+".checked") == true) 
{
 ...
 <td><input type="checkbox" name="ch11" value="ch11" disabled="disabled"   <? if($ch11) echo 'checked';?> onClick="security_deposit(ch11,ch12,ch13,1)"></td>
 <td>Supplier is required to pay
  ...
  equivalent to Tk. <input type="text" name="tch112" value="<? echo $tch112;?>" size="10" style="border:0" readonly="">  in form of Bank draft/Pay Order in favour of BFEW on receiving letter of intent but before issue of Work Order.<i>(Under Construction)</i></td>
</tr>
<tr>
 <td><input type="checkbox" name="ch12" value="ch12"  <? if($ch12) echo 'checked';?> disabled onClick="security_deposit(ch11,ch12,ch13,2)"></td>
<td>Security Deposit will be returned with the Final payment.<i>(Under Construction)</i></td>
</tr>
<tr>
 ...
 <td>Security Deposit will be returned within 
      <input type="text" name="tch131" value="<? echo $tch131;?>" size="10"> days after sattlement of Final payment.<i>(Under Construction)</i></td>
</tr>

<tr>
 <td><input type="checkbox" name="ch15" value="ch15"  <? if($ch15) echo 'checked';?> disabled="disabled"  onClick="security_deposit(ch15,ch16,ch17,1)"></td>
 <td><input type="text" name="tch151" value="<? echo $tch151;?>" size="10"> %  amount will be deducted from every running bill as Retention money.<i>(Under Construction)</i></td>
</tr>

<tr>
 <td><input type="checkbox" name="ch16" value="ch16"  <? if($ch16) echo 'checked';?> disabled onClick="security_deposit(ch15,ch16,ch17,2)"></td>
<td>Retention money will be paid with the Final payment.<i>(Under Construction)</i></td>
</tr>
<tr>
 <td><input type="checkbox" name="ch17" value="ch17"  <? if($ch17) echo 'checked';?> disabled onClick="security_deposit(ch15,ch16,ch17,3)"></td>
    <td>Retention money will be paid within 
      <input type="text" name="tch171" value="<? echo $tch171;?>" size="10"> days after settlement of Final payment.<i>(Under Construction)</i></td>
</tr>
<!--
<tr>
