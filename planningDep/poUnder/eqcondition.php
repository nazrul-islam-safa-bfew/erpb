...
<tr>
 ...
 <td>Overtime Rate will be <input type="text" name="tch6" size="4" width="4" maxlength="3"> % Extra per hour</td>
</tr>
<tr>
...
<tr>
 <td><input type="checkbox" name="ch11" value="ch11" checked></td>
 <td>During mobilization if equipment leave supplier's yard after 12 am, no rent will be incur that day.</td>
</tr>
<tr>
 <td><input type="checkbox" name="ch12" value="ch12"  checked></td> 
...
<tr>
  <td><input type="checkbox" name="ch14" value="ch14"  checked ></td>
