...
$activeDate1 = formatDate($activeDate,$format);
	if($posl){
		...
		$ch10.'_'.$ch11.'_'.$ch12.'_'.$ch13.'_'.
		$ch14.'_'.$ch15.'_'.$ch16.'_'.$tch6.'_'.$tch13.'_'.$ch25.'_'.$tch251.'_'.$ch26.'_'.$ch27.'_'.$ch28.'_'.$ch29;
...
if($r>=0){
	...
	$poid = mysql_insert_id();
		 ...
		 $fd=date('Y-m-d',$fd);
		 $sqls = "INSERT INTO poscheduletemp(pos, poid, sdate, qty) VALUES ('','$poid', '$fd', '${porderQty.$i}')";
