...
$tch13=$temp[17];
$tch251=$temp[19];
$tch141=$temp[25]=="ch24" ? $temp[26] : intval($temp[25]);
$tch142=$temp[25]=="ch24" ? $temp[27] : $temp[26];
$tch143=$temp[27];
$ll=1;
?>
...
<tr>
 <td><? echo $ll++;?>.</td>
<td>Advance <? echo $tch141;?>% of the Work Order amount which is Tk. <? echo number_format($tch142);?> will be paid along with this Work Order. Advanced Amount will be adjusted on prorate basis from every bill.</td>
</tr>
<? }?>
<tr>
<? if($ch5){?>
