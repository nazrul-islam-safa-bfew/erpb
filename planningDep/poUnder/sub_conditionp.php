...
$tch141=$temp[30];
$tch142=$temp[31];
$tch151=$temp[32]; //advanced amount parcent
$tch171=$temp[33];
$tch181=$temp[35];
$tch251=$temp[36];
$tch252=$temp[37];
...
<tr>
<td valign="top"><? echo $l++;?></td>
 <td>Contractor is required to pay Security deposit <? echo $tch111;?>% of the Work Order amount,
...
<tr>
<td valign="top"><? echo $l++;?></td>
<td>Advance <? echo $tch141;?> % of the Work Order amount which is Tk.<? echo $tch142;?>  will be paid along with this Work Order.
...
<? echo intval($tch251)>0 ? $tch251 : (intval($tch252)>0 ? $tch252 : 0);?>% of the Work Completed amount as Daily Progress Payment.</td>
</tr>
<? }?>
<? if($ch15){?>
<tr>
