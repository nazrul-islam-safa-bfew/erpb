<form name="search" action="./index.php?keyword=show all requisition" method="post">
...
?>
 ...
 <tr>
     ...
     <td><input type="checkbox">Fund Not Available</td> 
 </tr>
 <tr>	 
     <td><input type="checkbox">Fund Allocated</td>
     <td><input type="checkbox">Fund Not Allocated</td> 
     <td><input type="checkbox">Already Purchased</td>
  </tr>
 <tr>
