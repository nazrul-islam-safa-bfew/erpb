...
// 	echo $sqlp;	 
mysqli_query($db,"insert into porderHelper (posl,qID,itemCode) value ('$posl','$qID','$itemCode')");
// echo mysqli_error($db);		 
		 
// 	 echo "<br>** $sqlp **<br>";
	 //else echo "<br>t$i=".${t.$i};
	$sqlrunp= mysqli_query($db, $sqlp);
	$poid = mysqli_insert_id($sqlrunp);
...
if(!$typel1[itemCode])continue;
?>
    <tr>
      <td align="center" width='10%'><? echo $typel1[itemCode]?>
 <input type="hidden" name="itemCode<? echo $i;?>" value="<? echo $typel1[itemCode].";". $typel1[rate].";".$typel1[qRef].";".$typel1[delivery].' '.myprojectName($typel1[deliveryLoc]).' '.$typel1[sDetail].";". $typel1[qid];?>">
