...
<? include_once('plvendorSearch.php');?>
...
?>
        <tr > 
		 ...
		 <? if(valid1($qresult[valid])){	 ?>
		  <a href="./index.php?keyword=purchase+order&vid=<? echo $qresult[vid];?>&project=<? echo $qresult[pCode];?>&itemCode=<? echo $qresult[itemCode];?> "><? echo $qresult[itemCode];?></a>
          <? } else { echo $qresult[itemCode]; }?>  
		  </td>
		  ...
		  echo $c.date("d-m-Y",strtotime($qresult[valid])).' </font>';
		  ?>
