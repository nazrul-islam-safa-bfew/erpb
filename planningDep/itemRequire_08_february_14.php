...
<tr><td class="ablueAlertHd_small" colspan="3"><? if($loginDesignation=='Managing Director') echo "Site Requisitions"; else echo "Create Purchase Order";?></td></tr>
<tr><td>Project</td>
<td colspan="2">
...
<tr>
  ...
  <td colspan="2"><input type="text" name="requisition"> Days</td>
</tr>

<tr><td>Item Code</td>
    <td >
	<input name="itemCode11" onKeyUp="return autoTab(this, 2, event);" size="2" maxlength="2" > - 
    <input name="itemCode12" onKeyUp="return autoTab(this, 2, event);" size="2" maxlength="2"> - 
    <input name="itemCode13" onKeyUp="return autoTab(this, 3, event);" size="3" maxlength="3" >
	</td>
    <td>
	<input name="itemCode21" onKeyUp="return autoTab(this, 2, event);" size="2" maxlength="2" > - 
    <input name="itemCode22" onKeyUp="return autoTab(this, 2, event);" size="2" maxlength="2"> - 
    <input name="itemCode23" onKeyUp="return autoTab(this, 3, event);" size="3" maxlength="3" >
	</td>
...
<table width="98%" align="center" border="1" bordercolor="#00aaFF" cellpadding="3" cellspacing="0" style="border-collapse:collapse">
 <tr bgcolor="#0099FF">
   ...
   <th class="th1">Unit</th>
   <th class="th1"><? if($requisition!="") echo $requisition; else echo "10"; ?> Days Req.</th>   
   <th class="th1">Quotation<br> at Hand</th>   
 </tr>
 <?
 include("config.inc.php");
...
<br>
 ...
 <?php
        ...
        $appendSearch= "&pcode=$pcode&req=$requisition&type=$type&itemCode1=$itemCode1&itemCode2=$itemCode2";
        $range= 5;
