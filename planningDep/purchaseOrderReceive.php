...
?>
<form name="srf" action="./index.php?keyword=purchase+order+receive" method="post" enctype="multipart/form-data">
...
elseif($loginDesignation=="Store Officer")$sqlp22 .=" and paymentSL not like 'EP_%'";
...
if($posl){
	...
	<a target="_blank" href="./po_auto_close.php?posl=<?php echo $posl; ?>">Close</a>
     </td>
</tr>
</table>
<br><br>
