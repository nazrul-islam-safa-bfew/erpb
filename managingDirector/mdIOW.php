<table  align="center" width="98%" border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="0"  style="border-collapse:collapse" >
    <tr> 
      <td bgcolor="#DDDDDD" height="25" colspan="6"   >Project Name: <b><? echo $reqpCode;?></b></td>
    </tr>
...
$sqlp = "SELECT `*` from `requisition` WHERE reqIow='$reqiow' ORDER BY `reqIow`";
//echo $sqlp;
...
<? $sqlItem = "SELECT itemlist.*, dma.* from `itemlist`,`dma` where itemCode='$dmaRun[reqItemCode]'  AND dmaItemCode='$dmaRun[reqItemCode]'";
//echo $sqlItem;
