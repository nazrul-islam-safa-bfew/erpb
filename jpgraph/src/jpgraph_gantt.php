...
require_once($localPath."/jpgraph/src/jpgraph_plotband.php");
require_once($localPath."/jpgraph/src/jpgraph_iconplot.php");
require_once($localPath."/jpgraph/src/jpgraph_plotmark.inc.php");

// Maximum size for Automatic Gantt chart
define('MAX_GANTTIMG_SIZE_W',8000000000000);
define('MAX_GANTTIMG_SIZE_H',5000000000000);
...
class HeaderProperty {
    ...
    public $iTitleVertMargin=3,$iFFamily=FF_FONT0,$iFStyle=FS_NORMAL,$iFSize=6;
    public $iStyle=0;
