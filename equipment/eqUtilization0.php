...
if($rr!=1)	{
	for($i=1;$i<$n;$i++){
		...
		VALUES ('', '$eqId','$itemCode', '${iow.$i}', '${siow.$i}', '$stime', '$etime', '',
...
<form name="equt" action="./eqUtilization.php?<? echo "eqId=$eqId&itemCode=$itemCode&edate=$edate&eqType=$eqType&posl=$posl";?>" method="post">
