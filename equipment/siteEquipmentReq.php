...
<form name="eqre" action="./equipment/equipmentSql.php"  method="post">
<table align="center" width="500" border="3"  bordercolor="CC9999" cellpadding="5" cellspacing="0" style="border-collapse:collapse">
<tr bgcolor="#CC9999">
 <td align="right" valign="top" colspan="2"><font class='englishhead'>Equipment Requisition Form</font></td>
</tr>
 <tr>
   <td> Equipment Id</td><td><? echo $eqid;?>
    <input type="hidden" name="eqCode" value="<? echo $eqid;?>">
   </td>   
 </tr>
<tr bgcolor="#FFEEEE">
   <td> Equipment Description</td><td><? $test = itemDes($eqid); echo $test[des].', '.$test[spc];?></td>   
 </tr>
