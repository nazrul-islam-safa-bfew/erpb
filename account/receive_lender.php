<table   width="600" align="center" border="2" bordercolor="#999999" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
 ...
 <tr>
  ...
  <tr>
    ...
    <td colspan="3" align="center"><input type="button" value="Cash Receive" name="cashT" onClick="if(checkrequired(receive)){receive.submit();}"> 
      <input type="hidden" name="lendercashReceive" value="1">
	</td>
 </tr>
 </table>
