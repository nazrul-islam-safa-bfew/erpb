...
-->
 ...
 <?
  ...
  <input type="hidden" name="n" value="<? echo $i;?>">
    <tr>
    <td colspan="6" align="right" bgcolor="#FFFFCC"> 	<input type="text" readonly="" name="total" id="total" style=" border:0;background: #FFFFCC;text-align:right"></td>
 </tr>

  <tr>
    <td  align="center" colspan="3"><input type="button" value="calculate" name="calculate" onClick="calc(this.form);twoDigitConversation(this.form,'total');"></td>
