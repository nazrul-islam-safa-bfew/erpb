 ...
 <tr>
  ...
  <tr>
    <td colspan="1" align="center">
			<input type="button" value="calculate" name="calculate" onClick="if(!this.form.paidTo.value){return false;}calc(this.form);twoDigitConversation(this.form,'total');">
		</td>
    <td colspan="2" align="center">
			<input type="button" value="Save" disabled="disabled" name="save" 
	onClick="if(checkrequired(payments)) {
	payments.expencess.value=1;payments.calculate.value=0;payments.submit();}">
		</td>
...
<?php
include("cash_purchase_temp.php");
