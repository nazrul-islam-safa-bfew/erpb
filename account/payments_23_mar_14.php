...
<table  width="800" align="center" >
  ...
  <td><input type="radio" name="w"  value="7"   <? if($w==7) echo "checked";?> onClick="location.href='./index.php?keyword=payments&w=7'">Wages (Master Roll) Payment</td>
  </tr>
</table>
 ...
 <tr>
   ...
   <td width="39">Date 
    ...
    cal.showNavigationDropdowns();
      ...
      <td width="203"><input type="text" maxlength="10" name="paymentDate" value="<? echo $paymentDate; ?>" alt="req" title="Payment Date" readonly=""> 
        <a id="anchor" href="#"
...
<? if($w==4){?>	
	...
	payments.exfor.options[document.payments.exfor.selectedIndex].value+'&vid='+
