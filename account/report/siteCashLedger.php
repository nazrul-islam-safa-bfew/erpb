...
<? ?>
<form name="gl" action="./index.php?keyword=sitecash+ledger" method="post">
<table  width="600" align="center" border="0" class="blue" >
 <tr bgcolor="#CCCCFF">
 <td align="right" valign="top" height="30" colspan="4"><font class='englishheadblack'>cash ledger</font></td>
</tr>
 <tr>
...
if(myarray_search ('5501000',  $accountId)){ $crAmount=0;$drAmount=0;
  $openingBalance=openingBalance('5501000',$fromDate,$pcode);?> 
  <tr class="bg" >
    <td colspan='7' align='left' >Opening Balance</td>
    <td  align='right' ><? echo number_format($openingBalance,2);?></td>
  </tr> 
