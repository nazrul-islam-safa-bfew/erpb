...
<form name="cdj" action="./index.php?keyword=scash+disbursment" method="post">
<table  width="600" align="center" border="0" class="ablue" >
 ...
 <tr>  <td >Project: </td><td>5502000-Site Cash<? echo $loginProjectName; $pcode=$loginProject;?></td>	</tr>
<!--  <tr>
