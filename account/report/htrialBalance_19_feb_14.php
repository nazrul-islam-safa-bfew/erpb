...
elseif($re[accountID]=='2404000'){ $balance=$normalDayAmountgTotalup_finual+$total_idle_amount; }
...
elseif($re[accountID]=='6804000'){ $balance=$normalDayAmountgTotalup_finual;}   
elseif($re[accountID]=='6805000'){ $balance=$total_idle_amount;}
