...
function all_list_of_data($toDate,$fromDate,$pcode){
	...
	{
		 $total_idle_amount_with_usages=count_normal_day_differently('31/01/2014',date("d/m/Y",strtotime($fromDate)),$pcode);	
...
if($all_list_of_data_f==1)
 ...
 elseif($re[accountID]=='6804000') // for utileze amount
 {
