...
// $amount=eq_ex_idle($pcode,$fromDate,$toDate);
 ...
 elseif($re[accountID]=='6804000')
 {
	...
	/*
	$reset_from_date=explode("/",$fromDate);
	$reset_to_date=explode("/",$toDate);

	$nFd=$reset_from_date[2]."-".$reset_from_date[1]."-".$reset_from_date[0];
	$nTd=$reset_to_date[2]."-".$reset_to_date[1]."-".$reset_to_date[0];
	*/
