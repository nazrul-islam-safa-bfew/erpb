 ...
 
{
 ...
 echo $re[accountID].' '.accountName($re[accountID])."<b>*</b>";
...
echo number_format($total_idle_amount);
 elseif($re[accountID]=='6804000')
echo number_format($normalDayAmountgTotalup_finual);
...
<tr bgcolor="#FFFFCC" >
 ...
 echo number_format($Gprofit,2);?>%</div></td>  
</tr>
<tr><td height="20">&nbsp;</td></tr>
<tr bgcolor="#99CCFF" >
...
$iow=$resultiow[iowId];
	 ...
	 $sqlf = "SELECT SUM(dmaRate*dmaQty) as humanRate FROM dma WHERE dmaiow='$iow' AND dmaItemCode between '70-00-000' AND '99-99-999'";
...
<tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Manpower Cost of Sales Approved</td>
<td></td>
<td align="right">
<?
...
<tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Equiment Cost of Sales Approved</td>
<td></td>
<td align="right">
<?
...
<tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Material Cost of Sales Approved</td>
<td></td>
<td align="right"><?
...
$TotalExpApp=$ManExpApp+$EqExpApp+$MatExpApp;
echo  number_format($TotalExpApp,2);
?></strong></td>
<td align="right"><strong><?
$TotalExpAppPer=$MatExpAppPer+$EqExpAppPer+$ManExpAppPer;
...
<? }//else pcode?>
<div style="width:575px; margin:10px auto;"><b>* </b> From the project starting date.</div>
