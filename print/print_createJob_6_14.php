...
<table align="left" width="650" border="0"  bordercolor="CC9999" cellpadding="5" cellspacing="0" style="border-collapse:collapse">
	...
	<tr>
	<td colspan="2" valign="top">
	<fieldset class="border"><legend class="englishheadBlue">Personal Trait</legend>

	 <table width="100%" cellpadding="0" cellspacing="0" border="0">
	   <tr>
	     <td width="120" valign="top"><li style="list-style: square inside">Personal Trait</li></td>
