...
"  AND  salaryType in ('Salary','Wages Monthly','Consolidated' ) and empId='$id'".
...
//echo "$actualSalaryProject-$paid-$withoutPayAmountTotal<br>";
 ...
 <tr>
 <tr>
  <td colspan="7" align="right"> Total Amount: <? echo number_format($totalAmount,2);?> </td>
