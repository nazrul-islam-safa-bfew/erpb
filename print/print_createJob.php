...
function nl2any($string, $tag = 'li', $feed = ''){
  // making tags
  $start_tag = "<$tag list-style: square inside; style='margin-bottom:.075in;'" . ($feed ? ' '.$feed : '') . '>' ;  $end_tag = "</$tag>";  
		 ...
		 <div class="border">
			 <table width="100%" cellpadding="5" cellspacing="0">
				...
				<tr>
					...
					<td>
						<?
						$sqlp1="SELECT * from `itemlist` WHERE itemCode='$designation'";
// 						echo $sqlp;
						$sqlrunp1=mysqli_query($db, $sqlp1);
						$result=mysqli_fetch_array($sqlrunp1);
						?><? echo $result[1]; ?>
						<? // $temp=itemDes($designation);echo $temp[des];?>
					</td>
				</tr>
					<tr>
...
<!-- 	<tr>
	...
	<legend class="englishheadBlue">Personality Traits</legend>
	</fieldset>
	</td>
	</tr>	 -->
	...
	<fieldset class="border"><legend class="englishheadBlue">Job Requirements</legend>
	 ...
	 <table width="100%" cellpadding="0" cellspacing="0" border="0">
	   <tr>
	     <td width="120" valign="top"><li style="list-style: square inside">Personality Traits</li></td>
		 <td><? if($app[personality_trait]){?><ul><?  echo nl2any($app[personality_trait]);?></ul><? }?></td>
	   </tr>
	 </table>
...
<!-- 	   <tr>
		 ...
		 <td ><?
			 $incumbent=getIncumbent($temp[empId]);
			 $temp=itemDes($app[incumbent]);echo $temp[des];?></td>
	   </tr> -->
...
<!-- 	<tr>
 ...
 <br>
  <br><div style="float:left; width:90%; margin-top:20px;">
  <? include('../bottom.php');?> </div>
</body>
