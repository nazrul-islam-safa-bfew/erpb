...
<?php
	...
	$sql_daily="select * from  dailyreport where edate='$ed' and pcode='$loginProject'";
	$q_daily=mysqli_query($db,$sql_daily);
	$row_daily=mysqli_fetch_array($q_daily);	
?>
...
: <input type="text" width="100" size="100" name="des<? echo $j;?>" disabled="disabled" value="<? echo iow_progerss_variance($re[iowId],$ed);?>"style="color:#FF3333">
...
: <input type="text" width="100" size="100" disabled="disabled" name="clientdes<? echo $j;?>" value="<? echo iow_progerss_changeOrder($re[iowId],$ed);?>"style="color:#FF3333">
