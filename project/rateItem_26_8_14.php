...
//echo $sqlitemtool;
$sqlrunItemtool= mysql_query($sqlitemtool);
$sql="INSERT INTO toolrate (id,itemCode,averageValue,salvageValue,life) Values ('','$itemCode','','10','6')";
//	echo $sql;
	$sqlrunItem1= mysql_query($sql);
 }
...
$sqlrun= mysql_fetch_array($sqlrunItem1);
if(!$sqlrun){
$sql1="SELECT * from itemlist where itemCode='$itemCode' ";
$sqlrunItem1= mysql_query($sql1);
$sqlrun= mysql_fetch_array($sqlrunItem1);
...
<tr><td>Item Code</td> <td><? $temp=explode('-',$sqlrun[itemCode]);?>
    ...
    <input name="itemCode3"onKeyUp="return autoTab(this, 3, event);" size="4" maxlength="3" value="<? echo $temp[2]?>">

</td></tr>
<tr><td>Item Description</td> <td><input type="text" name="itemDes" size="40" value="<? echo $sqlrun[itemDes];?>"></td></tr>
<tr><td>Item Specification</td> <td><input type="text" name="itemSpec" value="<? echo $sqlrun[itemSpec];?>"></td></tr>
...
onChange="location.href='index.php?keyword=rate+Item&s='+itm.items.options[document.itm.items.selectedIndex].value";>
    ...
    <option value="88" <? if($s=='88') echo 'selected';?>>88-00-000 Direct Labour Skilled</option>
    <option value="89" <? if($s=='89') echo 'selected';?>>89-00-000 Direct Labour Semi Skilled</option>
    <option value="90" <? if($s=='90') echo 'selected';?>>90-00-000 Direct Labour Unskilled</option>
...
$sqlrunItem= mysql_query($sqlitem);
$i=1;
while($result=mysql_fetch_array($sqlrunItem)){
