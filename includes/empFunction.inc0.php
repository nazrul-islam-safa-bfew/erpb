...
function departmentList($selected=null){ //backdated
	  $designationList=array(
			'71'=>["code"=>"71-00-000","designation"=>"Director"],
			'72'=>["code"=>"72-00-000","designation"=>"Construction & Engineering Department"],
			'73'=>["code"=>"73-00-000","designation"=>"Manager & Executive"], //Design & Estimation Department
			'74'=>["code"=>"74-00-000","designation"=>""], //Accounts & MIS Department
			'75'=>["code"=>"75-00-000","designation"=>"Office Assistant"], //Human Resource Department
			'76'=>["code"=>"76-00-000","designation"=>""], //Procurement Department
			'77'=>["code"=>"77-00-000","designation"=>"Foreman & Supervisor"], //Store & Logistic Department
			'78'=>["code"=>"78-00-000","designation"=>"High Skill Labor"], //Business Development & Marketing Department
			'79'=>["code"=>"79-00-000","designation"=>""], //Project Department
			'80'=>["code"=>"80-00-000","designation"=>"Construction Department"],
			'81'=>["code"=>"81-00-000","designation"=>"Workshop"],
			'82'=>["code"=>"82-00-000","designation"=>""], //Equipment & Rental Sevices Department
			'83'=>["code"=>"83-00-000","designation"=>""],
			'84'=>["code"=>"84-00-000","designation"=>""],
			'85'=>["code"=>"85-00-000","designation"=>""]
		);
...
function appraisalActionCounter($type=null){
	global $db;
	$sql="select count(*) ass from appaction where `action`=$type and actionStatus='1'";
// 	echo $sql;
	$q=mysqli_query($db,$sql);
	$row=mysqli_fetch_array($q);
...
function fullDesignationToEmpID($designation){
	...
	return [$designationArr[0],$designationArr[1],$lastOctet];
}
