 ...
 while($typel= mysql_fetch_array($sqlrunp))
		...
		" AND action in('P','HP') ORDER by itemCode ASC ";
		 ...
		 while($r=mysql_fetch_array($sql))
			...
			$dailyBreakDown=eq_dailyBreakDown($r[eqId],$r[itemCode],$r[edate],'H',$pcode);
			$toDaypresent=eq_toDaypresent($r[eqId],$r[itemCode],$r[edate],'H',$pcode);
